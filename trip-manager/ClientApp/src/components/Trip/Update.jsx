...
export class Update extends Component {
    ...
    onSubmit(e) {
        ...
        let tripObject = {
            ...
            dateStarted: new Date(this.state.dateStarted).toISOString(0,10),
            dateCompleted: this.state.dateCompleted ? new Date(this.state.dateCompleted).toISOString(0,10) : null
        }
